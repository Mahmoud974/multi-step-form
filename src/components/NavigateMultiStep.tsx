...
const NavigateMultiStep = () => {
  ...
  <ul className="flex md:justify-start md:flex-col md:ml-12 mt-12  md:mt-6 justify-center space-x-3 md:space-x-0 py-20 md:py-0">
    <NavLink to='/'>
      ...
      <p className={`text-xl border w-8 h-8 rounded-full text-center ${location.pathname === '/step1' ? 'bg-blue-200 text-black' : null}`}>1</p>
...
<li className='flex text-white items-center md:mt-6'>
      <p className={`text-xl border w-8 h-8 rounded-full text-center ${location.pathname === '/step2' ? 'bg-blue-200 text-black' : null}`}>2</p>
      <div className="ml-4 md:flex md:flex-col hidden">
    ...
    <li className='flex text-white items-center md:mt-6'>
      <p className={`text-xl border w-8 h-8 rounded-full text-center ${location.pathname === '/step3' ? 'bg-blue-200 text-black' : null}`}>3</p>
      <div className="ml-4 md:flex md:flex-col hidden">
     ...
     <li className='flex text-white items-center md:mt-6'>
      <p className={`text-xl border w-8 h-8 rounded-full text-center ${location.pathname === '/step4' ? 'bg-blue-200 text-black' : null}`}>4</p>
      <div className="ml-4 md:flex md:flex-col hidden">
