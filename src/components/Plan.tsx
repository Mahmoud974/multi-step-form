  ...
  return (
    <div >
        ...
        <ul className="flex space-x-5 mt-8">
            {
                plan.map((level,index) => <li key={index}  className="cursor-pointer p-6 border w-36 h-44 border-gray-300 rounded-xl hover:border-violet-500 "  onClick={()=> activeBox(level)}>
        ...
        <div className="bg-gray-100 space-x-4 flex justify-center mt-6 py-4 rounded-md">
